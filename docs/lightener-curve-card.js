    ...
    `,n=this.curves.filter(e=>e.visible).map(i=>{const r=Ae(Me(i.controlPoints,e));return q`
      ...
      >
        ...
        ${(()=>{if(this.readOnly)return G;if(0===this.curves.length)return q`<text class="hint hint-select" text-anchor="middle"
                x="${194}" y="${112}"
                >Add a light below to get started</text>`;if(null===this.selectedCurveId&&this._dragCurveIdx<0){const e=this._graphHintDismissed?"Select a light to edit its curve":"Select a light, then click its curve to add a control point";return q`<text class="hint hint-select" text-anchor="middle"
                x="${194}" y="${112}"
                >${e}</text>`}const e=this.curves.find(e=>e.entityId===this.selectedCurveId),t=this._isMobile?"Double-tap add · Hold remove":"Double-click to add · Right-click to remove";return q`
...
>
      ...
      >
        ...
        <div class="workspace">
          ...
          <div class="side-rail">
            ...
            ></curve-legend>
            ${this._manageError?V`<div class="error" role="alert">${Fe} ${this._manageError}</div>`:G}
          </div>
  ...
  `,e([ve()],Ke.prototype,"_curves",void 0),e([ve()],Ke.prototype,"_originalCurves",void 0),e([ve()],Ke.prototype,"_config",void 0),e([ve()],Ke.prototype,"_selectedCurveId",void 0),e([ve()],Ke.prototype,"_saveState",void 0),e([ve()],Ke.prototype,"_loadError",void 0),e([ve()],Ke.prototype,"_loading",void 0),e([ve()],Ke.prototype,"_manageError",void 0),e([ve()],Ke.prototype,"_managingLights",void 0),e([ve()],Ke.prototype,"_scrubberPosition",void 0),e([ve()],Ke.prototype,"_cancelAnimating",void 0),e([ve()],Ke.prototype,"_hass",void 0),e([ve()],Ke.prototype,"_previewActive",void 0),e([ve()],Ke.prototype,"_showPresets",void 0),e([ve()],Ke.prototype,"_legendCloseAddSignal",void 0),e([ve()],Ke.prototype,"_legendCloseRemoveSignal",void 0),e([ve()],Ke.prototype,"_manageMode",void 0),Ke=e([he("lightener-curve-card")],Ke);export{Ke as LightenerCurveCard,qe as LightenerCurveCardEditor};
